...
contains
  ...
  subroutine soild_write_header(header)
    ...
    if(monolis_mpi_get_global_my_rank() == 0 .and. is_debug) write(*,"(a)")"* "//trim(header)
  ...
  subroutine soild_debug_int(header, n)
    ...
    if(monolis_mpi_get_global_my_rank() == 0 .and. is_debug) write(*,"(a,i12)")"** soild debug: "//trim(header)//": ", n
  ...
  subroutine soild_debug_real(header, r)
    ...
    if(monolis_mpi_get_global_my_rank() == 0 .and. is_debug) write(*,"(a,1pe12.5)")"** soild debug: "//trim(header)//": ", r
  ...
  subroutine soild_debug_char(header, char)
    ...
    if(monolis_mpi_get_global_my_rank() == 0 .and. is_debug) write(*,"(a,a)")"** soild debug: "//trim(header)//": ", trim(char)
  ...
  subroutine soild_debug_logical(header, l)
    ...
    if(monolis_mpi_get_global_my_rank() == 0 .and. is_debug) write(*,"(a,l)")"** soild debug: "//trim(header)//": ", l
