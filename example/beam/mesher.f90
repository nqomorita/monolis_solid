program main
  ...
  open(30, file="load.dat",status='replace')
    !ngrp
    ip1 = 0
    do k = 1, NZ
      do j = 1, NY
    ...
    do k = 1, NZ
      do j = 1, NY
        do i = 1, NX
          if(i == NX)then
            if(j ==  1 .and. k ==  1)then; write(30,"(i8,a)") in, ", 2, 0.1"; cycle; endif
            if(j ==  1 .and. k == NZ)then; write(30,"(i8,a)") in, ", 2, 0.1"; cycle; endif
            if(j == NY .and. k ==  1)then; write(30,"(i8,a)") in, ", 2, 0.1"; cycle; endif
            if(j == NY .and. k == NZ)then; write(30,"(i8,a)") in, ", 2, 0.1"; cycle; endif
            if(j ==  1)then; write(30,"(i8,a)") in, ", 2, 0.2"; cycle; endif
            if(j == NY)then; write(30,"(i8,a)") in, ", 2, 0.2"; cycle; endif
            if(k ==  1)then; write(30,"(i8,a)") in, ", 2, 0.2"; cycle; endif
            if(k == NZ)then; write(30,"(i8,a)") in, ", 2, 0.2"; cycle; endif
            write(30,"(i8,a)") in, ", 2, 0.4"
          endif
